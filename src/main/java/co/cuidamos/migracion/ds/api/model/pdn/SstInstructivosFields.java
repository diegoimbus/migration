...
@Entity
@Table(name = "sst_instructivos_fields")
public class SstInstructivosFields implements Serializable {

	    private static final long serialVersionUID = 1L;
	    @Id
	    @GeneratedValue(strategy = GenerationType.IDENTITY)
	    @Basic(optional = false)
	    @Column(name = "id_sst_instructivos_field")
	    private Integer idSstInstructivosField;
		...
		public Integer getIdSstInstructivosField() {
			return idSstInstructivosField;
		}
		public void setIdSstInstructivosField(Integer idSstInstructivosField) {
			this.idSstInstructivosField = idSstInstructivosField;
		}
