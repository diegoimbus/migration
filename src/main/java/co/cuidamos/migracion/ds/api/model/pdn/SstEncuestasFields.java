...
@Entity
@Table(name = "sst_encuestas_fields")
public class SstEncuestasFields implements Serializable {

  	    private static final long serialVersionUID = 1L;
	    @Id
	    @GeneratedValue(strategy = GenerationType.IDENTITY)
	    @Basic(optional = false)
	    @Column(name = "id_sst_encuestas_field")
	    private Integer idSstEncuestasField;
	    @Column(name = "label")
...
//	    @OneToMany(mappedBy = "fidSstEncuestasField")
//	    private Collection<SstEncuestasData> sstEncuestasDataCollection;
		...
		public Integer getIdSstEncuestasField() {
			return idSstEncuestasField;
		}

		public void setIdSstEncuestasField(Integer idSstEncuestasField) {
			this.idSstEncuestasField = idSstEncuestasField;
		}
