...
@Entity
@Table(name = "sst_epp_fields")
public class SstEppFields implements Serializable{

    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Basic(optional = false)
    @Column(name = "id_sst_epp_field")
    private Integer idSstEppField;
    @Column(name = "label")
    ...
    @OneToMany(mappedBy = "fidSstEppField")
    private Collection<SstEppDataPdn> sstEppDataCollection;

    @Column(name = "upload_number_files")
    private Integer uploadNumberFiles;

	public Integer getIdSstEppField() {
		return idSstEppField;
	}

	public void setIdSstEppField(Integer idSstEppField) {
		this.idSstEppField = idSstEppField;
	}
	...
	public Collection<SstEppDataPdn> getSstEppDataCollection() {
		return sstEppDataCollection;
	}

	public void setSstEppDataCollection(Collection<SstEppDataPdn> sstEppDataCollection) {
		this.sstEppDataCollection = sstEppDataCollection;
	}
