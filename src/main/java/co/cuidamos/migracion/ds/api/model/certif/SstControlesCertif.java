...
@Entity
@Table(name = "sst_controles", schema = "esqcore")
@TypeDef(name = "JsonDataUserType", typeClass = JsonDataUserType.class)
public class SstControlesCertif {
    ...
    @NotNull
    @Column(name = "sstcontroles")
    @Type(type = "JsonDataUserType")
    private String sstControles;
	...
	public String getSstControles() {
		return sstControles;
	}

	public void setSstControles(String sstControles) {
		this.sstControles = sstControles;
	}
