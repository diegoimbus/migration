...
@Entity
@Table(name = "sst_at_el_gestion", schema = "esqcore")
public class SstAtelGestionCertif {
    ...
    @NotNull
    @Column(name = "atelgestion")
    @Type(type = "JsonDataUserType")
    private String atelGestion;
	...
	public String getAtelGestion() {
		return atelGestion;
	}

	public void setAtelGestion(String atelGestion) {
		this.atelGestion = atelGestion;
	}
