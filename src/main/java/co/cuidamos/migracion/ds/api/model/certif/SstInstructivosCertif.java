...
@Entity
@Table(name = "sst_instructivos",schema = "esqcore")
@TypeDef(name = "JsonDataUserType", typeClass = JsonDataUserType.class)
public class SstInstructivosCertif {
	    ...
	    @NotNull
	    @Column(name = "sstinstructivos")
	    @Type(type = "JsonDataUserType")
	    private String sstInstructivos;
		...
		public String getSstInstructivos() {
			return sstInstructivos;
		}

		public void setSstInstructivos(String sstInstructivos) {
			this.sstInstructivos = sstInstructivos;
		}
