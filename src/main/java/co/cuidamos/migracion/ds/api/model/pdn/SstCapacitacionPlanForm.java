...
@Entity
@Table(name = "sst_capacitacion_plan_form")
public class SstCapacitacionPlanForm implements Serializable {
	   private static final long serialVersionUID = 1L;
	    @Id
	    @GeneratedValue(strategy = GenerationType.IDENTITY)
	    @Basic(optional = false)
	    @Column(name = "id_sst_capacitacion_plan_form")
	    private Integer idSstCapacitacionPlanForm;
		...
		public Integer getIdSstCapacitacionPlanForm() {
			return idSstCapacitacionPlanForm;
		}
		public void setIdSstCapacitacionPlanForm(Integer idSstCapacitacionPlanForm) {
			this.idSstCapacitacionPlanForm = idSstCapacitacionPlanForm;
		}
