...
@Entity
@Table(name = "sst_sociodemo_fields")
public class SstSociodemoFields implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Basic(optional = false)
    @Column(name = "id_sst_sociodemo_field")
    private Integer idSstSociodemoField;
    @Column(name = "label")
    ...
    @OneToMany(mappedBy = "fidSstSociodemoField")
    private Collection<SstSociodemoDataPdn> sstSociodemoDataCollection;
	public Integer getIdSstSociodemoField() {
		return idSstSociodemoField;
	}
	public void setIdSstSociodemoField(Integer idSstSociodemoField) {
		this.idSstSociodemoField = idSstSociodemoField;
	}
