...
@Entity
@Table(name = "sst_salud_trabaj_fields")
public class SstSaludTrabajFields implements Serializable{

	    private static final long serialVersionUID = 1L;
	    @Id
	    @GeneratedValue(strategy = GenerationType.IDENTITY)
	    @Basic(optional = false)
	    @Column(name = "id_sst_salud_trabaj_field")
	    private Integer idSstSaludTrabajField;
	    @Column(name = "label")
...
//	    @OneToOne(cascade = CascadeType.ALL, mappedBy = "sstSaludTrabajFields")
//	    private SstSaludTrabajData sstSaludTrabajData;
	    @Column(name = "upload_number_files")
	    private Integer uploadNumberFiles;

		public Integer getIdSstSaludTrabajField() {
			return idSstSaludTrabajField;
		}

		public void setIdSstSaludTrabajField(Integer idSstSaludTrabajField) {
			this.idSstSaludTrabajField = idSstSaludTrabajField;
		}
