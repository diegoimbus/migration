...
@Entity
@Table(name = "sst_riesgos_tipo",schema = "esqcore")
@TypeDef(name = "JsonDataUserType", typeClass = JsonDataUserType.class)
public class SstRiesgosTipoCertif {
    ...
    @NotNull
    @Column(name = "sstriesgostipo")
    @Type(type = "JsonDataUserType")
    private String sstRiesgosTipo;
	...
	public String getSstRiesgosTipo() {
		return sstRiesgosTipo;
	}

	public void setSstRiesgosTipo(String sstRiesgosTipo) {
		this.sstRiesgosTipo = sstRiesgosTipo;
	}
