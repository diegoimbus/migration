...
@Entity
@Table(name = "sst_responsable",schema = "esqcore")
@TypeDef(name = "JsonDataUserType", typeClass = JsonDataUserType.class)
public class SstResponsableCertif {
    ...
    @NotNull
    @Column(name = "sstresponsable")
    @Type(type = "JsonDataUserType")
    private String sstResponsable;
	...
	public String getSstResponsable() {
		return sstResponsable;
	}

	public void setSstResponsable(String sstResponsable) {
		this.sstResponsable = sstResponsable;
	}
