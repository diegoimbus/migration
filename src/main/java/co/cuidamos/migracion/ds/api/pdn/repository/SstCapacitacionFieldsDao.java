...
import co.cuidamos.migracion.ds.api.model.pdn.SstCapacitacionPlanFields;

@Repository
public interface SstCapacitacionFieldsDao extends JpaRepository<SstCapacitacionPlanFields, Long>{
