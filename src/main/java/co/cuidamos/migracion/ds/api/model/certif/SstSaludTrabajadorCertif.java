...
@Entity
@Table(name = "sst_salud_trabajador",schema = "esqcore")
@TypeDef(name = "JsonDataUserType", typeClass = JsonDataUserType.class)
public class SstSaludTrabajadorCertif {
    ...
    @NotNull
    @Column(name = "sstsaludtrabajador")
    @Type(type = "JsonDataUserType")
    private String sstSaludTrabajador;
	...
	public String getSstSaludTrabajador() {
		return sstSaludTrabajador;
	}

	public void setSstSaludTrabajador(String sstSaludTrabajador) {
		this.sstSaludTrabajador = sstSaludTrabajador;
	}
