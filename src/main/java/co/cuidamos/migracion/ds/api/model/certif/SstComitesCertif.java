...
@Entity
@Table(name = "sst_comites_data", schema = "esqcore")
public class SstComitesCertif {
    ...
    @NotNull
    @Column(name = "comited_data")
    @Type(type = "JsonDataUserType")
    private String comitesData;
	...
	public String getComitesData() {
		return comitesData;
	}

	public void setComitesData(String comitesData) {
		this.comitesData = comitesData;
	}
