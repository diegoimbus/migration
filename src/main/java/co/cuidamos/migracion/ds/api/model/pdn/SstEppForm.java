...
@Entity
@Table(name = "sst_epp_form")
public class SstEppForm implements Serializable {

	   private static final long serialVersionUID = 1L;
	    @Id
	    @GeneratedValue(strategy = GenerationType.IDENTITY)
	    @Basic(optional = false)
	    @Column(name = "id_sst_epp_form")
	    private Integer idSstEppForm;
		...
		public Integer getIdSstEppForm() {
			return idSstEppForm;
		}
		public void setIdSstEppForm(Integer idSstEppForm) {
			this.idSstEppForm = idSstEppForm;
		}
